...
extern const u8 gText_Birch_PowerRumor[];
extern const u8 gText_Birch_PowerYes[];
extern const u8 gText_Birch_PowerNo[];
...
extern const u8 gText_PpMax48BP[];
...
extern const u8 gText_Charcoal64BP[];
extern const u8 gText_MysticWater64BP[];
extern const u8 gText_MiracleSeed64BP[];
extern const u8 gText_Magnet64BP[];
extern const u8 gText_HardStone64BP[];
extern const u8 gText_NeverMeltIce64BP[];
extern const u8 gText_BlackBelt64BP[];
extern const u8 gText_PoisonBarb64BP[];
extern const u8 gText_SoftSand64BP[];
extern const u8 gText_SharpBeak64BP[];
extern const u8 gText_SilverPowder64BP[];
extern const u8 gText_TwistedSpoon64BP[];
extern const u8 gText_SpellTag64BP[];
extern const u8 gText_BlackGlasses64BP[];
extern const u8 gText_DragonFang64BP[];
extern const u8 gText_SilkScarf64BP[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SoftSandDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SharpBeakDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SilverPowderDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_DragonFangDesc[];
