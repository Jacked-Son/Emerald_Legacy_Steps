...
const u8 gText_PpMax48BP[] = _("PP MAX{CLEAR_TO 0x64}48BP");
...
const u8 gText_Charcoal64BP[] = _("CHARCOAL{CLEAR_TO 0x5E}64BP");
const u8 gText_MysticWater64BP[] = _("MYSTIC WATER{CLEAR_TO 0x5E}64BP");
const u8 gText_MiracleSeed64BP[] = _("MIRACLE SEED{CLEAR_TO 0x5E}64BP");
const u8 gText_Magnet64BP[] = _("MAGNET{CLEAR_TO 0x5E}64BP");
const u8 gText_HardStone64BP[] = _("HARD STONE{CLEAR_TO 0x5E}64BP");
const u8 gText_NeverMeltIce64BP[] = _("NEVER MELT ICE{CLEAR_TO 0x5E}64BP");
const u8 gText_BlackBelt64BP[] = _("BLACK BELT{CLEAR_TO 0x5E}64BP");
const u8 gText_PoisonBarb64BP[] = _("POSION BARB{CLEAR_TO 0x5E}64BP");
const u8 gText_SoftSand64BP[] = _("SOFT SAND{CLEAR_TO 0x5E}64BP");
const u8 gText_SharpBeak64BP[] = _("SHARP BEAK{CLEAR_TO 0x5E}64BP");
const u8 gText_SilverPowder64BP[] = _("SILVER POWDER{CLEAR_TO 0x5E}64BP");
const u8 gText_TwistedSpoon64BP[] = _("TWISTED SPOON{CLEAR_TO 0x5E}64BP");
const u8 gText_SpellTag64BP[] = _("SPELL TAG{CLEAR_TO 0x5E}64BP");
const u8 gText_BlackGlasses64BP[] = _("BLACK GLASSES{CLEAR_TO 0x5E}64BP");
const u8 gText_DragonFang64BP[] = _("DRAGON FANG{CLEAR_TO 0x5E}64BP");
const u8 gText_SilkScarf64BP[] = _("SILK SCARF{CLEAR_TO 0x5E}64BP");
...
const u8 gText_MonOverworldOn[] = _("OFF");
const u8 gText_MonOverworldOff[] = _("ON");
