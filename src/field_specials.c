...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_HOLD_ITEM_VENDOR] =
    {
        ...
        gText_MetalCoat64BP,
        gText_Charcoal64BP,
        gText_MysticWater64BP,
        gText_MiracleSeed64BP,
        gText_Magnet64BP,
        gText_HardStone64BP,
        gText_NeverMeltIce64BP,
        gText_BlackBelt64BP,
        gText_PoisonBarb64BP,
        gText_SoftSand64BP,
        gText_SharpBeak64BP,
        gText_SilverPowder64BP,
        gText_TwistedSpoon64BP,
        gText_SpellTag64BP,
        gText_BlackGlasses64BP,
        gText_DragonFang64BP,
        gText_SilkScarf64BP,
        gText_Exit
    },
