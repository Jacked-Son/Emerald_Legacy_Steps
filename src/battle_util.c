...
u8 ItemBattleEffects(u8 caseID, u8 battlerId, bool8 moveTurn)
{
    ...
    case ITEMEFFECT_ON_SWITCH_IN:
        ...
        case HOLD_EFFECT_X_ATTACK:
            ...
            break;
        case HOLD_EFFECT_X_DEFEND:
            if (gBattleMons[battlerId].statStages[STAT_DEF] < MAX_STAT_STAGE)
            {
            ...
            break;
        case HOLD_EFFECT_X_SPEED:
            if (gBattleMons[battlerId].statStages[STAT_SPEED] < MAX_STAT_STAGE)
            {
        ...
        case HOLD_EFFECT_X_SPECIAL:
            ...
            break;
        case HOLD_EFFECT_X_ACCURACY:
            if (gBattleMons[battlerId].statStages[STAT_ACC] < MAX_STAT_STAGE)
            {
